                        ...
                        <div class="card-body">
                            ...
                            <form action="../../../function/update.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address" name="alamat" value="<?php echo isset($_SESSION['alamat']) ? $_SESSION['alamat'] : ''; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" class="form-control" id="password" name="password" value="<?php echo isset($_SESSION['password']) ? $_SESSION['password'] : ''; ?>">
                                </div>
                                <div class="mt-3">
                                    <input type="hidden" name="id" value="<?php echo isset($_SESSION['id']) ? $_SESSION['id'] : ''; ?>">
                                    <button type="submit" name="editProfile" value="editProfile" class="btn btn-primary">Update
                                        Profile</button>
                                </div>
                            </form>
